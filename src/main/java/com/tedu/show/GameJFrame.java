...
public class GameJFrame extends JFrame {
    public static int GameX = 814;
    public static int GameY = 511;
    private JPanel jPanel = null;// 面板
    private KeyListener keyListener = null;// 键盘监听
    private MouseMotionListener mouseMotionListener = null;// 鼠标移动状态监听
    private MouseListener mouseListener = null;// 鼠标点击监听
    private MouseWheelListener mouseWheelListener = null;// 鼠标滚轮监听
